 ...
 *   2. At each shot, sample Sentinel-2 (+ a canopy-height layer) as the
 ...
 * shot date, lat, lon, Sentinel-2 post-monsoon/dry-season NDVI + EVI,
 * post-monsoon/dry-season-matched reflectance bands B2-B12 (B10 excluded:
 * it is an L1C-only cirrus band, not present in the L2A surface-reflectance
 * product), and canopy height.
 *
 * CLAUDE.md rules this script follows:
 *   - Rule 3: does NOT use the Meta/WRI ~2016 canopy height model (blind to
 *     anything planted after 2016) — uses a current (~2020) product instead.
...
// Current (~2020) 10 m canopy height product (Lang et al. 2022), NOT the
// 2016 Meta/WRI CHM. Verify this asset ID still resolves in the Code Editor
// before running — community-catalog paths occasionally move.
...
// =============================================================================
// 3. Sample Sentinel-2 + canopy height at each GEDI shot, matched by year
// =============================================================================
